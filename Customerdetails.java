...
public class Customerdetails
{
 ...
 int custage;
 Customerdetails(String custid,String custname,String custgender,String custaddress,String custcity,String custcountry,String custpin,String custphone,String customeraof,String custdob,int custage)
 {
  this.custid=custid;
  ...
  this.custage=custage;
   ...
   public static void main(String args[])
   {
    try
    {
     FileOutputStream fs=new FileOutputStream("C:\\Users\\mruser\\custdetailstxt");
     FileInputStream fs1=new FileInputStream("C:\\Users\\mruser\\custdetailstxt");
     ...
     String cp="";
     int cage; 
     ArrayList<Customerdetails> obj=new ArrayList<Customerdetails>();
     ...
     for(int j=0;j<10;j++)
     {
      ...
      cage=sc.nextInt();
       ...
       Customerdetails cds=new Customerdetails(cid,cn,cg,ca,cc,ccy,cpi,cp,caof,cdob,cage);
       obj.add(cds);
      }
